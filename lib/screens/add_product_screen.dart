...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  final _lowStockThresholdController = TextEditingController(text: '7'); // New controller with default
                ...
                if (_newImageFiles.isNotEmpty || _newPickedImageBytes.isNotEmpty)
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      const Text('Images to Upload:', style: TextStyle(fontWeight: FontWeight.bold)),
